...
//         {/* Mobile View Layout */}
//         <div className="block md:hidden max-w-7xl mx-auto px-4 space-y-4">
...
//               className="bg-white border border-neutral-100 p-5 rounded-2xl shadow-sm w-full"
//             >
...
//                 ))}
//               </div>
//               <p className="text-neutral-700 text-sm font-medium leading-relaxed mb-3">"{review.text}"</p>
//               <div className="flex flex-col">
//                 <h4 className="font-bold text-neutral-900 text-xs">{review.name}</h4>
//                 <p className="text-[10px] text-neutral-400 font-medium mt-0.5">{review.role}</p>
//               </div>
//             </motion.div>
//           ))}
//         </div>
