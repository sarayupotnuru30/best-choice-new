...
import { motion } from "framer-motion";
import { Phone, MapPin, Clock, Instagram, Truck } from "lucide-react";
    ...
    <>
      ...
      <section className="pt-32 pb-12 bg-gradient-blush text-center">
        ...
        <h1 className="font-display text-5xl md:text-6xl font-bold mt-2">
          We'd <span className="text-gradient">Love</span> to Hear From You
        </h1>
        <p className="mt-4 text-muted-foreground max-w-xl mx-auto px-4">
          Visit our physical store layout or reach out directly via our social channels.
        </p>
      </section>

      {/* Info Blocks Grid Container */}
      <section className="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Business Hours */}
          <div className="bg-gradient-primary rounded-3xl p-8 text-primary-foreground shadow-glow sm:col-span-2 text-center">
          ...
          {/* Address Info */}
          <div className="bg-card rounded-3xl p-6 border border-border shadow-card flex gap-4 items-center">
            <MapPin className="w-6 h-6 text-primary shrink-0" />
            <div>
              <p className="font-semibold">Address</p>
              <p className="text-muted-foreground text-sm mt-1">
                26/27/14, Chinna Gantiyada, Kanthi Road, Gajuwaka, Vizag
              </p>
            </div>
          </div>
          ...
          <div className="bg-card rounded-3xl p-6 border border-border shadow-card flex gap-4 items-center">
            ...
            <div>
              <p className="font-semibold">Call Us</p>
              <p className="text-muted-foreground text-sm mt-1">
                <a href="tel:8143078003" className="hover:text-primary transition">8143078003</a> ·{" "}
                <a href="tel:9063821610" className="hover:text-primary transition">9063821610</a>
              </p>
            </div>
          </div>
          ...
          <div className="bg-card rounded-3xl p-6 border border-border shadow-card flex gap-4 items-center">
            ...
            <div>
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="text-muted-foreground text-sm mt-1 hover:text-primary transition block"
              >
                @best_choice_gajuwaka
              </a>
            </div>
          </div>

          {/* Online Logistics Banner */}
          <div className="glass rounded-3xl p-6 flex items-center gap-4">
            <Truck className="w-8 h-8 text-primary shrink-0" />
            <div>
              <p className="font-display text-lg font-bold">Online Delivery Available</p>
              <p className="text-sm text-muted-foreground">
                We deliver across Vizag — place your orders on our WhatsApp portal.
              </p>
            </div>
          </div>
        </motion.div>
      ...
      {/* Embedded Store Front Interactive Map */}
      <section className="pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-[2rem] overflow-hidden shadow-card border border-border">
          <iframe
            title="Best Choice Location Map Frame"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3802.261271101918!2d83.1967153!3d17.6799804!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a3969f97a076af7%3A0x2dd37186e6a1ee92!2sBest%20Choice!5e0!3m2!1sen!2sin!4v1716123456789!5m2!1sen!2sin"
            className="w-full h-[450px] border-0"
            loading="lazy"
            referrerPolicy="no-referrer-when-downgrade"
